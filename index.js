...
class Instructor extends Lambdasian{
  constructor(instrAttr){
    super(instrAttr);
    this.isInstructor = instrAttr.isInstructor;
...
class Student extends Lambdasian{
  constructor(stuAttr){
    super(stuAttr);
    this.isStudent = stuAttr.isStudent;
